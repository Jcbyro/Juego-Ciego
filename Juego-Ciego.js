...
function cafeteria_compu() {
    ...
    document.getElementById("opc1-ciego-compu").removeEventListener("click", cafeteria_compu)    
...
function tren_compu() {
    ...
    document.getElementById("opc1-ciego-compu").innerHTML =
    "Un bosque"
    document.getElementById("opc1-ciego-compu").addEventListener("click", bosque_compu)

    document.getElementById("opc2-ciego-compu").innerHTML =
    "Un parque"
    document.getElementById("opc2-ciego-compu").addEventListener("click", parque_1_compu)
}
...
function parque_1_compu() {
    ...
    document.getElementById("opc1-ciego-compu").removeEventListener("click", bosque_compu)
    document.getElementById("opc2-ciego-compu").removeEventListener("click", parque_1_compu)
